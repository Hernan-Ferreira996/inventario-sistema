...
<div class="col-md-6"><div class="form-check"><input type="checkbox" name="exento_iva" value="1" class="form-check-input" {{ old('exento_iva', $cliente->exento_iva) ? 'checked' : '' }}><label class="form-check-label">Exento de IVA</label></div></div>
