...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute proporcionado ha aparecido en una filtración de datos. Elegí un :attribute diferente.',
    ],
    ...
    |--------------------------------------------------------------------------
    | El sistema ya usa nombres de campo en español (nombre, ruc_nit, etc.),
    | así que la mayoría no necesita traducción. Solo se listan los que
    | quedarían raros mostrados tal cual (snake_case, inglés heredado).
    */
    'attributes' => [
        'ruc_nit' => 'RUC/NIT',
        ...
        'termino_pago_id' => 'término de pago',
        'password' => 'contraseña',
